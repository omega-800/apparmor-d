{
  security.apparmor-d.profiles = {
    ...
    "edid-decode" = "disable";
    "eject" = "disable";
    "element-desktop.apparmor.d" = "disable";
    "elinks" = "disable";
    "engrampa" = "disable";
    "ephy-profile-migrator" = "disable";
    "epiphany.apparmor.d" = "disable";
    ...
    "sftp-server" = "disable";
    "sgdisk" = "disable";
    "signal-desktop.apparmor.d" = "disable";
    "signal-desktop-chrome-sandbox" = "disable";
    "sing-box" = "disable";
    "slirp4netns.apparmor.d" = "disable";
    "smartctl" = "disable";
    "smartd" = "disable";
    "smbspool" = "disable";
    "smplayer" = "disable";
    ...
    "systemd-coredump.apparmor.d" = "disable";
    ...
    "thunderbird.apparmor.d" = "disable";
    ...
    "transmission.apparmor.d" = "disable";
    "tumblerd" = "disable";
    "tunables" = "disable";
    "tune2fs" = "disable";
    ...
    "unhide-rb" = "disable";
    "unhide-tcp" = "disable";
    "unix-chkpwd.apparmor.d" = "disable";
